...
const styles = StyleSheet.create({
  ...
  scrollContent: {
    ...
    paddingTop: theme.spacing['3xl'],     // IMPROVED: increased from 2xl
  ...
  header: {
    alignItems: 'center',
    marginBottom: theme.spacing['3xl'],  // IMPROVED: increased from 2xl
  },
  badge: {
    marginBottom: theme.spacing.lg,      // IMPROVED: increased from base
  },
  ministryText: {
    marginBottom: theme.spacing.base,    // IMPROVED: increased from xs
    letterSpacing: 2,
    fontSize: theme.typography.fontSize.sm,  // IMPROVED: increased from xs
  },
  systemTitle: {
    marginBottom: theme.spacing.lg,      // IMPROVED: increased from sm
    fontSize: theme.typography.fontSize['2xl'],  // IMPROVED: increased from xl
    fontWeight: '700',
  },
  welcomeMessage: {
    marginBottom: theme.spacing.lg,      // IMPROVED: increased from base
    opacity: 0.95,                       // IMPROVED: increased from 0.9
    paddingHorizontal: theme.spacing.xl, // IMPROVED: increased from base
    lineHeight: 22,                      // IMPROVED: increased from fontSize.sm * 1.6
  ...
  loginForm: {
    ...
    padding: theme.spacing['3xl'],       // IMPROVED: increased from 2xl
    ...theme.shadows.xl,
  ...
  securityBadge: {
    ...
    gap: theme.spacing.sm,               // IMPROVED: increased from xs
    paddingTop: theme.spacing.lg,        // IMPROVED: increased from base
