          ...
          <View style={styles.progressBar}>
            <View style={styles.progressStep}>
              <View style={[styles.progressDot, styles.progressDotComplete]}>
                <Feather name="check" size={10} color={theme.colors.special.white} />
              </View>
            ...
            <View style={styles.locationDetails}>
              ...
              <Card style={styles.coordCard}>
                <View style={styles.coordRow}>
                  <Feather name="map-pin" size={22} color={theme.colors.primary[600]} />
                ...
                <View style={styles.coordRow}>
                  <Feather name="target" size={22} color={getAccuracyColor(location.coords.accuracy)} />
                  <View style={styles.coordContent}>
                    <Label color="primary" style={styles.coordLabel}>
                      Độ chính xác
                    </Label>
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingBottom: theme.spacing.lg,            // IMPROVED: increased from base
  },
  backButton: {
    padding: theme.spacing.sm,                  // IMPROVED: increased from xs
  },
  headerTitle: {
    fontWeight: '600',
  ...
  progressBar: {
    ...
    paddingHorizontal: theme.spacing.base,      // IMPROVED: added padding
  },
  progressStep: {
    alignItems: 'center',
    minWidth: 60,                               // IMPROVED: added min width
  },
  progressDot: {
    width: 14,                                  // IMPROVED: increased from 12
    height: 14,                                 // IMPROVED: increased from 12
    borderRadius: 7,                            // IMPROVED: increased from 6
  ...
  progressLine: {
    width: 50,                                  // IMPROVED: increased from 40
    height: 2,
    backgroundColor: theme.colors.neutral[300],
    marginHorizontal: theme.spacing.sm,         // IMPROVED: increased from xs
    marginBottom: 26,                           // IMPROVED: adjusted for new dot size
  },
  ...
  capturePrompt: {
    alignItems: 'center',
    paddingVertical: theme.spacing['3xl'],      // IMPROVED: increased from 2xl
    paddingHorizontal: theme.spacing.lg,        // IMPROVED: added padding
  },
  promptTitle: {
    marginTop: theme.spacing.xl,                // IMPROVED: increased from lg
    marginBottom: theme.spacing.base,           // IMPROVED: increased from sm
  },
  promptDescription: {
    opacity: 0.7,
    marginBottom: theme.spacing['2xl'],         // IMPROVED: increased from xl
    paddingHorizontal: theme.spacing.lg,        // IMPROVED: reduced from xl for better fit
  ...
  captureButton: {
    minWidth: 220,                              // IMPROVED: increased from 200
    paddingVertical: theme.spacing.base,        // IMPROVED: added explicit padding
  },
  locationDetails: {
    alignItems: 'center',
    paddingHorizontal: theme.spacing.base,      // IMPROVED: added padding
  ...
  coordRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: theme.spacing.xs,          // IMPROVED: added padding
  },
  coordContent: {
    flex: 1,
  ...
  coordValue: {
    fontSize: theme.typography.fontSize.xl,     // IMPROVED: increased from lg
    fontWeight: '600',
    lineHeight: 26,                             // IMPROVED: added line height
  },
  coordDivider: {
    height: 1,
    backgroundColor: theme.colors.neutral[200],
    marginVertical: theme.spacing.lg,           // IMPROVED: increased from base
  },
  infoCard: {
    width: '100%',
    padding: theme.spacing.lg,                  // IMPROVED: increased from base
  ...
  infoText: {
    ...
    marginLeft: theme.spacing.base,             // IMPROVED: increased from sm
    fontSize: theme.typography.fontSize.base,   // IMPROVED: increased from sm
    lineHeight: 26,                             // IMPROVED: increased from 20 - CRITICAL FIX
  },
  retryButton: {
    width: '100%',
    marginTop: theme.spacing.base,              // IMPROVED: added margin
  },
  footer: {
    flexDirection: 'row',
    padding: theme.spacing.xl,                  // IMPROVED: increased from lg
