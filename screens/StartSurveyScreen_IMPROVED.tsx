          ...
          <View style={styles.typeGrid}>
            {objectTypes.map((type) => (
              ...
              >
                ...
                {type.description && (
                  <Label color="primary" style={styles.typeDescription} numberOfLines={2}>
                    {type.description}
                  </Label>
                )}
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  contentContainer: {
    ...
    paddingBottom: theme.spacing['2xl'],    // IMPROVED: added explicit bottom padding
  },
  progressSection: {
  ...
  sectionDescription: {
    ...
    lineHeight: 22,                         // IMPROVED: added line height
  },
  typeGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
  ...
  typeCard: {
    width: '47%',                           // IMPROVED: reduced from 48% for better gap
    ...
    ...theme.shadows.sm,
    minHeight: 130,                         // IMPROVED: added min height
  },
  typeCardSelected: {
  ...
  typeName: {
    ...
    lineHeight: 20,                         // IMPROVED: added line height
  },
  typeNameSelected: {
  ...
  typeDescription: {
    ...
    marginTop: theme.spacing.xs,            // IMPROVED: increased from 2
    lineHeight: 18,                         // IMPROVED: added line height
  },
  infoCard: {
    padding: theme.spacing.lg,              // IMPROVED: increased from base
